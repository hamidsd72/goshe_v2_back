    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(null=True, upload_to='avatar', verbose_name='آواتار')),
                ('timer', models.DateTimeField(default=django.utils.timezone.now)),
                ('code', models.IntegerField(null=True)),
                ('birthDay', models.DateField(auto_now_add=True, null=True, verbose_name='تاریخ تولد')),
                ('codeMelly', models.CharField(max_length=10, null=True, verbose_name='کد ملی')),
                ('province', models.CharField(max_length=100, null=True, verbose_name='استان')),
